...
TEST(CodegenTest, ImageRet_CodeGen) {
  ...
  regList[0].name = destName.size() + 1;
  
  regList[1] = regList[0];
  regList[1].name = regList[0].name + reg1Name.size() + 1;

  regList[2] = regList[1];
  regList[2].name = regList[1].name + reg2Name.size() + 1;

  regList[3] = regList[2];
  regList[3].name = regList[2].name + reg3Name.size() + 1;
  ...
  regList[0].type = Brigb32;
  regList[0].reserved = 0;
  regList[0].name = destName.size() + regName.size() + 2;
  ...
  reg3.type = Brigb32;
  reg3.reserved = 0;
  reg3.name = destName.size() + regName.size() + reg1Name.size() + reg2Name.size() + 4;
  ...
  reg2.type = Brigb32;
  reg2.reserved = 0;
  reg2.name = destName.size() + regName.size() + 2;
...
TEST(CodegenTest, ImageNoRet_CodeGen) {
  ...
  reg3.type = Brigb32;
  reg3.reserved = 0;
  reg3.name = src2Name.size() + 1;

  reg4.size = sizeof(reg4);
  reg4.kind = BrigEOperandReg;
  reg4.type = Brigb32;
  reg4.reserved = 0;
  reg4.name = src2Name.size() + src3Name.size() + 2;
  ...
  reg3.type = Brigb32;
  reg3.reserved = 0;
  reg3.name = reg1Name.size() + reg2Name.size() + 2;
  ...
  reg3.type = Brigb32;
  reg3.reserved = 0;
  reg3.name = reg1Name.size() + reg2Name.size() +
  ...
  reg3.type = Brigb32;
  reg3.reserved = 0;
  reg3.name = regName.size() + reg1Name.size() + reg2Name.size() + 3;
  ...
  reg3.type = Brigb32;
  reg3.reserved = 0;
  reg3.name = regName.size() + reg1Name.size() + 2;
  ...
  reg3.type = Brigb32;
  reg3.reserved = 0;
  reg3.name = regName.size() + reg2Name.size() + 2;
  ...
  reg3.type = Brigb32;
  reg3.reserved = 0;
  reg3.name = regName.size() + reg1Name.size() + reg2Name.size() + 
              reg3Name.size() + reg4Name.size() + 5;
