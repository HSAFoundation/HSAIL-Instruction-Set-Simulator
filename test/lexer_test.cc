...
unsigned long integerconstant_output[]=
{
  0,
  1234567,
  2147483647,
...
class Bug1_IntegerConstant : public ::testing::TestWithParam<int>
{
};
TEST_P(Bug1_IntegerConstant, IntegerConstants)
{
  ...
  EXPECT_EQ(integerconstant_output[n], context->token_value.int_val);
