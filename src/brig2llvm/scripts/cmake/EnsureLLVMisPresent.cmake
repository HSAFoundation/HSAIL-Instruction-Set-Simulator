...
MESSAGE("llvm is present")
  execute_process( COMMAND ${Subversion_SVN_EXECUTABLE} switch http://llvm.org/svn/llvm-project/llvm/branches/release_34/ ${dest_dir}/${name} )
  execute_process( COMMAND ${Subversion_SVN_EXECUTABLE} up ${dest_dir}/${name} )
else(EXISTS "${dest_dir}/${name}")
Find_Package(Subversion)

if(${Subversion_FOUND})
  execute_process( COMMAND ${Subversion_SVN_EXECUTABLE} co http://llvm.org/svn/llvm-project/llvm/branches/release_34/ ${dest_dir}/${name} )
